...
```notes
VMs definitely have their place, but...

What if we used Docker and containerized our apps/services?
```
---
...
Instead of worry about defining a Dockerfile for our MongoDB, let's use an existing image instead...
```
