export default () => (
  <article>
    <h1>Welcome</h1>
    If you have followed the instructions correctly, you should be able to view
    the following in your local environment:
    <ul>
      <li>
      ...
      <li>
        <a
          href="https://github.com/TheRobBrennan/learning-graphql"
          target="__blank"
        >
          GitHub Repo
        </a>
